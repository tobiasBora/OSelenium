...
(* OASIS_START *)
(* DO NOT EDIT (digest: 64cb23225fd10ff732e1554cb29e9830) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["TobiasBora"];
          homepage = None;
          synopsis = "An Ocaml Binding for Selenium WebDriver.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "`\2210\227\170\144\018\1338\196\209\017\212\002<\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
